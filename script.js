...
function machineGun(text) {
  ...
  for (i = 0; i < wordCount; i++) {
    ...
    element = $("<h3 id='hola'>" + word + "</h3>").appendTo(container);
    ...
    tl.to(element, duration, { scale: 1.5, ease: "slow(0.25, 0.9)" }, time).to(
      element,
      duration,
...
machineGun(
  "Istanbul's lost souls, freaky-witches, missing-zombies, mighty-wizards and hopeless-heroes are gathering again for Halloween on the night of October 30th on Sunday at KLEIN-Phönix."
);

document.getElementById("myMusic").volume = 0.05;
